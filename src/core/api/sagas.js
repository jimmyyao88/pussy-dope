...
import { tracklistRequestActions ,likelistRequestActions} from 'src/core/tracklists/actions';
...
export const fetchUserLikes = fetchEntities.bind(null, api.fetchUserLikes, likelistRequestActions);
